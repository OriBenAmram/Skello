...
export function PopoverBgPicker({ isSideBarOpen, toggleSideMenu, popoverContent }) {
    ...
    return (< section className="popover-side-menu" style={isSideBarOpen ? { right: '0px' } : { right: '-400px' }}>
        {/* Color section */}
